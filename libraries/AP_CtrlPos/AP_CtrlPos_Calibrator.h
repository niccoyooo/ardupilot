...
#define AP_CTRLPOS_CAL_MAX_SAMPLES 50  // number of samples required before calibration begins

class AP_CtrlPos_Calibrator {
public:
    AP_CtrlPos_Calibrator() {};
...
private:
    ...
    struct {
        sample_t samples[AP_CTRLPOS_CAL_MAX_SAMPLES];   // buffer of sensor samples
